...
const SelectRole = () => {
    ...
    return (
        <div
            className="min-h-screen flex items-center justify-center bg-cover bg-center backdrop-blur-md"
            style={{ backgroundImage: `url('/ruta-imagenhospital4.png')` }}
        >
            <div className="bg-white/20 backdrop-blur-md p-8 rounded-2xl shadow-xl w-full max-w-md text-center border border-white/30">
                <h2 className="text-3xl font-bold text-black mb-6 drop-shadow-md">Selecciona tu rol</h2>
